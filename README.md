...
- 即時天氣顯示（Open-Meteo API，自動偵測位置）
- 系統硬體監控（CPU/GPU 溫度、RAM/VRAM、CUDA 使用率）
- 視窗可調大小，自動記住位置
- 天氣地區手動選擇（台灣各縣市）
- UI 重構：深色主題、脈衝漸變邊框、動畫效果
- 粒子系統與視覺效果（發光、陰影）
